...
import { CreateVariableSchema, UpdateVariableSchema, ListVariablesSchema, IdParamSchema } from '../schemas/index.js';
...
export const registerVariableTools = (server) => {
    // ============ List Variables ============
    server.registerTool('n8n_list_variables', {
...
Returns:
  List of variables with id, key, and value.`,
        ...
        const response = await get('/variables', queryParams);
    ...
    // ============ Get Variable ============
    server.registerTool('n8n_get_variable', {
...
Returns:
  Variable details with id, key, and value.`,
        ...
        const variable = await get(`/variables/${params.id}`);
        return {
    ...
    // ============ Create Variable ============
    server.registerTool('n8n_create_variable', {
...
Returns:
  The created variable.`,
        ...
        const variable = await post('/variables', params);
        return {
    ...
    // ============ Update Variable ============
    server.registerTool('n8n_update_variable', {
...
Returns:
  The updated variable.`,
        ...
        const variable = await put(`/variables/${id}`, updateData);
        return {
    ...
    // ============ Delete Variable ============
    server.registerTool('n8n_delete_variable', {
