...
import type { N8nExecution, N8nExecutionListItem, N8nPaginatedResponse } from '../types.js';

// Format execution for display
const formatExecution = (execution: N8nExecution | N8nExecutionListItem): string => {
  const statusEmoji = {
    success: '✅',
    error: '❌',
    running: '🔄',
