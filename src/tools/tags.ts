...
import type { N8nTag, N8nPaginatedResponse } from '../types.js';

// Format tag for display
const formatTag = (tag: N8nTag): string => {
  return `🏷️ **${tag.name}** (ID: ${tag.id})`;
};

export const registerTagTools = (server: McpServer): void => {
